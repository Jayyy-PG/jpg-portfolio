...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action:pan-y lets the page scroll vertically when a touch starts
    // on the image (reframe drag is disabled on the live site anyway).
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      if (srcAttr && srcAttr === this._failedSrc) srcAttr = '';
