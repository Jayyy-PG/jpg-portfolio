...
function ContactIcon({ type }) {
  const icons = {
    ...
    linkedin: <><rect x="4" y="4" width="16" height="16" rx="2" /><path d="M8 10.5v5.5" /><path d="M8 7.5h.01" /><path d="M12 16v-3.2a2.3 2.3 0 0 1 4.6 0V16" /><path d="M12 10.5V16" /></>,
      ...
      <div className="shell section__grid">
        ...
        <div className="contact-card section__media">
          <span className="eyebrow eyebrow--accent">
            <span data-show="en">Open to internships — Aargau / Zürich</span>
            <span data-show="de">Offen für Praktika — Aargau / Zürich</span>
          </span>
          ...
          <div className="contact-card__socials">
            ...
            <a className="contact-card__social" href="https://www.linkedin.com/in/jay-grenacher/" target="_blank" rel="noopener noreferrer">
              <ContactIcon type="linkedin" />LinkedIn
            </a>
