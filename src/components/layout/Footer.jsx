    ...
    <footer className="footer">
      <div className="shell footer__row">
        ...
        <div className="footer__meta">
          ...
          <a className="footer__link" href="https://www.linkedin.com/in/jay-grenacher/" target="_blank" rel="noopener noreferrer"><Icon type="linkedin" />linkedin / jay-grenacher</a>
